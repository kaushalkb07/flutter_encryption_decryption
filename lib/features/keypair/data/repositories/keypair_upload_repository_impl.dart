...
class KeyPairUploadRepositoryImpl implements KeyPairUploadRepository {
  ...
  Future<void> uploadKeys({
    ...
    final headers = <String, String>{
      ...
      'Authorization': 'Bearer ${authToken ?? "eyJhbGciOiJSUzI1NiIsInR5cCI6IkpXVCJ9.eyJfaWQiOiI2ODRkMzYzNjM0OTQxMTA3OWY0ZjkwYTciLCJ1c2VybmFtZSI6ImRyb3AiLCJzZXNzaW9uSWQiOiI2ODY0YjVjMTUzNjM0OTQ1YmFmMzIwZTEiLCJpYXQiOjE3NTE0MzA1OTQsImV4cCI6MTc1MjAzNTM5NH0.IMqtawKMbFZGtw6GEXvVr88JsCap5bY9sorc049YFKBSfm52_nYiFlT2IcVdsoHQOI3nT1WYDFX-AsRZjbaWfwlEGYRK6UO5gD9mTBrFTfRnIdn_VcQqEnCr9Tit0N3YRGp_fKkvfsDHd_V-2Tdito2tIfMO0sRdqaJRThOvSG8"}', // Replace or pass dynamically
    };
